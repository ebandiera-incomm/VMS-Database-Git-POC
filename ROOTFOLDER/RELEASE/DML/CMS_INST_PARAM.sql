...
BEGIN
    SELECT COUNT (1)
     ...
     WHERE     OBJECT_TYPE = 'TABLE'
           AND OWNER = 'VMSCMS'
           AND OBJECT_NAME = 'CMS_INST_PARAM_R91B2';
    ...
    THEN
        ...
        IF V_CNT = 0
        THEN
            INSERT INTO VMSCMS.CMS_INST_PARAM_R91B2 (CIP_INST_CODE,CIP_PARAM_KEY,CIP_PARAM_DESC,CIP_PARAM_VALUE,CIP_INS_USER,CIP_INS_DATE,CIP_LUPD_USER,CIP_LUPD_DATE,CIP_ALLOWED_VALUES,CIP_MANDATORY_FLAG,CIP_DISPLAY_FLAG,CIP_PARAM_UNIT,CIP_PARAM_DISP_TYPE,CIP_MULTILING_DESC,CIP_VALIDATION_TYPE) values 
        ...
        INSERT INTO VMSCMS.CMS_INST_PARAM
            SELECT *
              FROM VMSCMS.CMS_INST_PARAM_R91B2
             WHERE (CIP_INST_CODE,
                    CIP_PARAM_KEY,
                    CIP_PARAM_DESC,
                    CIP_PARAM_VALUE,
