...
PROMPT *** Build 3 ***			
	PROMPT *** DDL ROLLBACK ***	
    PROMPT     *** PROCEDURES  *****
    @$VMS_HOME/FEB_VMSGPRHOST_R93_RELEASE/ROOTFOLDER/RELEASE/ROLLBACK/SP_CHW_ORDER_REPLACE.prc
    @$VMS_HOME/FEB_VMSGPRHOST_R93_RELEASE/ROOTFOLDER/RELEASE/ROLLBACK/SP_PREAUTH_AUTH_MERCTXN_ISO93.prc
    @$VMS_HOME/FEB_VMSGPRHOST_R93_RELEASE/ROOTFOLDER/RELEASE/ROLLBACK/SP_PREAUTH_TXN_ISO93.prc
    @$VMS_HOME/FEB_VMSGPRHOST_R93_RELEASE/ROOTFOLDER/RELEASE/ROLLBACK/SP_REQUISITION_ID.prc        
    PROMPT     --------------------------------------------------------------------------------
...
PROMPT *** Build 1 ***			
    ...
    --@$VMS_HOME/FEB_VMSGPRHOST_R93_RELEASE/ROOTFOLDER/RELEASE/ROLLBACK/SP_DISPUTE_PROCESS.prc
    PROMPT     --------------------------------------------------------------------------------
