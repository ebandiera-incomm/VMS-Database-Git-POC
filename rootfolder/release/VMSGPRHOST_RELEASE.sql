SPOOL $VMS_HOME/JAN_VMSGPRHOST_R001_RELEASE/LOG/VMSGPRHOST_RELEASE_VMSCMS_R104_B2.log;
...
PROMPT DDL
    ...
    @$VMS_HOME/JAN_VMSGPRHOST_R001_RELEASE/VMSGPRHOST_R104_B0002/DDL/CREATE_BACKUP.sql
	PROMPT     --------------------------------------------------------------------------------	
	
	PROMPT     *** VMS_9234_GPP_TOKENS  ***
    @$VMS_HOME/JAN_VMSGPRHOST_R001_RELEASE/VMSGPRHOST_R104_B0002/DDL/VMS_9234_GPP_TOKENS.pkb
	PROMPT     --------------------------------------------------------------------------------

	PROMPT     *** DISABLE_INDEX  ***
    @$VMS_HOME/JAN_VMSGPRHOST_R001_RELEASE/VMSGPRHOST_R104_B0002/DDL/DISABLE_INDEX.sql
	PROMPT     --------------------------------------------------------------------------------		
